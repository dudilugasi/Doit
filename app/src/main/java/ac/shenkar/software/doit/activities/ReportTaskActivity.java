...
public class ReportTaskActivity extends AppCompatActivity implements OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(ac.shenkar.software.doit.R.layout.activity_report_task);

        imageView  = (ImageView) findViewById(ac.shenkar.software.doit.R.id.report_task_image_view);
        ...
        Spinner acceptStatusSpinner = (Spinner) findViewById(ac.shenkar.software.doit.R.id.report_task_accept_status_spinner);
        ...
        Spinner statusSpinner = (Spinner) findViewById(ac.shenkar.software.doit.R.id.report_task_status_spinner);
        ...
        TextView categoryTV = (TextView) findViewById(ac.shenkar.software.doit.R.id.report_task_category_value);
        TextView priorityTV = (TextView) findViewById(ac.shenkar.software.doit.R.id.report_task_priority_value);
        TextView locationTV = (TextView) findViewById(ac.shenkar.software.doit.R.id.report_task_location_value);
        TextView dueDateTV = (TextView) findViewById(ac.shenkar.software.doit.R.id.report_task_duetime_value);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (spinner.getId() == ac.shenkar.software.doit.R.id.report_task_accept_status_spinner) {
            acceptStatus = item;
            showStatus(item);
        }

        //if spinner is status spinner
        if (spinner.getId() == ac.shenkar.software.doit.R.id.report_task_status_spinner) {
            status = item;
            showAddPhoto(item);
        }
    }
    ...
    public void showStatus(String status) {
        LinearLayout statusLayout = (LinearLayout) findViewById(ac.shenkar.software.doit.R.id.report_task_status_container);
    ...
    public void showAddPhoto(String status) {
        LinearLayout photoLayout = (LinearLayout) findViewById(ac.shenkar.software.doit.R.id.report_task_add_photo_container);
